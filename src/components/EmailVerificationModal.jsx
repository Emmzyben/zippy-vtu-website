...
const EmailVerificationModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center mx-4">
        ...
        <h3 className="text-md font-medium text-gray-700 mb-2">Verify Your Email Address to continue</h3>
